...
class Ui_match_finish_dialog(object):
    def setupUi(self, match_finish_dialog):
        ...
        self.remove_btn.setGeometry(QtCore.QRect(220, 170, 91, 41))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.remove_btn.setFont(font)
        self.remove_btn.setObjectName("remove_btn")
        self.ok_btn = QtWidgets.QPushButton(match_finish_dialog)
        self.ok_btn.setGeometry(QtCore.QRect(400, 350, 91, 41))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.ok_btn.setFont(font)
        self.ok_btn.setObjectName("ok_btn")
        self.cancel_btn = QtWidgets.QPushButton(match_finish_dialog)
        self.cancel_btn.setGeometry(QtCore.QRect(300, 350, 91, 41))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
