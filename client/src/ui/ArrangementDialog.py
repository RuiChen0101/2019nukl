...
class Ui_arrangement_dialog(object):
    def setupUi(self, arrangement_dialog):
        ...
        self.date.setSelectedDate(QtCore.QDate(2019, 11, 25))
        self.date.setGridVisible(False)
        self.date.setHorizontalHeaderFormat(QtWidgets.QCalendarWidget.SingleLetterDayNames)
        self.date.setVerticalHeaderFormat(QtWidgets.QCalendarWidget.NoVerticalHeader)
        self.date.setNavigationBarVisible(True)
